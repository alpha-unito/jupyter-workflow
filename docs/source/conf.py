...
project = 'Jupyter Workflow'
copyright = '2022, Alpha Research Group, Computer Science Dept., University of Torino'
...
extlinks = {
    'config-schema': ('https://raw.githubusercontent.com/alpha-unito/jupyter-workflow/' + release +
                      '/jupyter_workflow/config/schemas/v1.0/%s', 'GH#'),
    'repo': ('https://github.com/alpha-unito/jupyter-workflow/tree/' + release + '/%s', 'GH#'),
}
